package com.haod.www.chatroot.tools;
...
import com.haod.www.chatroot.ChatApp;
...
还需要解决一下储存文件的路径问题
 */
public class SpeechSynTools implements SpeechSynthesizerListener {

    /********************* 需配置部分 *********************/
    //AppId
    private String APPID="11357016";
    //ApiKey
    private String APIKEY="PrppYDAMbnkox0IFWFEPCgBb";
    //SecretKey
    private String SECRETKEY="Oe5TjDadX5jIwqHBMP4IlUoiB3d6W4vK";
    /********************** 配置结束 *********************/

    private static final String TAG = "SpeechSynTools";
    private static volatile SpeechSynTools instance = null;
    private SpeechSynthesizer mSpeechSynthesizer;

    private static final String SAMPLE_DIR = Environment.getExternalStorageDirectory() + "/chat_robot/";
    private static final String SPEECH_FEMALE_MODEL_NAME = "bd_speech_syn_female.dat";
    private static final String TEXT_MODEL_NAME = "bd_speech_syn_text.dat";

    private SpeechSynTools() {
    }

    public static SpeechSynTools getInstance() {
        if (instance == null) {
            synchronized (SpeechSynTools.class) {
                if (instance == null) {
                    instance = new SpeechSynTools();
                }
            }
        }
        return instance;
    ...
    private static void copyAssetsFile2SDCard(Context context, String fileName, String path) {
        try {
